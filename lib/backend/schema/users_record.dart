...
class UsersRecord extends FirestoreRecord {
  ...
  // "last_recipe_name" field.
  String? _lastRecipeName;
  String get lastRecipeName => _lastRecipeName ?? '';
  bool hasLastRecipeName() => _lastRecipeName != null;
  ...
  void _initializeFields() {
    ...
    _lastRecipeName = snapshotData['last_recipe_name'] as String?;
...
Map<String, dynamic> createUsersRecordData({
  ...
  final firestoreData = mapToFirestore(
    <String, dynamic>{
      ...
      'last_recipe_name': lastRecipeName,
      'location': location,
    }.withoutNulls,
  );
...
class UsersRecordDocumentEquality implements Equality<UsersRecord> {
  ...
  bool equals(UsersRecord? e1, UsersRecord? e2) {
    return e1?.email == e2?.email &&
        ...
        e1?.lastRecipeName == e2?.lastRecipeName &&
